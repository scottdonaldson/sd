		...
		<?php the_post(); ?>
				...
				<article <?php post_class(); ?>>
					...
					<div class="entry-content">
						<img class="aligncenter size-full" title="Scott Donaldson. Photo by Thomas Dunn." alt="Scott Donaldson. Photo by Nate Ryan." src="http://scottdonaldson.net/wp-content/uploads/2014/07/Scott-Donaldson-2014-1000x800.jpg">
