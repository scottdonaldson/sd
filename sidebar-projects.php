<div class="sidebar projects">
        ...
        <a href="http://www.parsleyandsprouts.com" target="_blank">
        	...
        	<img src="<?php echo bloginfo('template_url'); ?>/images/Parsley-photo.jpg" alt="Parsley and Sprouts" />
        </a>
        <p>Minneapolis and St. Paul web and print design, code, and development.</p>  

        <a href="<?php echo home_url(); ?>/st-paul-skyways">
            <h4>St. Paul Skyways</h4>
            <img src="<?php echo bloginfo('template_url'); ?>/images/skyway-thumbnail.jpg" alt="St. Paul Skyways">
        </a>
